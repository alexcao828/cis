...
TCirc = np.load(root+'cis/mu=1e-3/validation_n.npy')[27]
accCirc =np.load(root+'cis/mu=1e-3/validation_acc.npy')[27]
plt.plot(TCirc, accCirc, 'ro', markersize=30, fillstyle='none', markeredgewidth=3)  

TCirc = np.load(root+'larm/mu=1e-3/val_T.npy')[189]
accCirc =np.load(root+'larm/mu=1e-3/val_acc.npy')[189]
plt.plot(TCirc, accCirc, 'ro', markersize=30, fillstyle='none', markeredgewidth=3)  

TCirc = np.load(root+'ppo/mu=1e-3/T_val.npy')[6]
accCirc =np.load(root+'ppo/mu=1e-3/acc_val.npy')[6]
plt.plot(TCirc, accCirc, 'ro', markersize=30, fillstyle='none', markeredgewidth=3)  

 

# plt.title('aucs: sil/larm=%.3f, '%(silAUC/larmAUC) + 'sil/ppo=%.3f'%(silAUC/ppoAUC), fontsize=20)
plt.xlabel('Mean T (words)', fontsize=20)
