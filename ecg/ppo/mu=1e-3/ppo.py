...
class ppo_train:
    ...
    def get_grads(self, spectrograms, y, T, T_slicer, phase):
        ra = tf.get_default_session().run(self.reward_acc, feed_dict={self.policy.spectrograms: spectrograms,
                                                                                              self.old_policy.spectrograms: spectrograms,
        ...
        if phase == 'train':
            grad, guess, ce, r, r_acc, t_stop = tf.get_default_session().run((self.gradients, self.guess, self.cross_entropy, self.reward, self.reward_acc, self.time_stop),
                                                                              feed_dict={self.policy.spectrograms: spectrograms,
                                                                                         self.old_policy.spectrograms: spectrograms,
                                                                                         self.y: y, self.T: T, self.T_slicer: T_slicer,
            ...
            return guess, ce, r, r_acc, t_stop
